namespace CustomerManagement.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶管理清單Repository Get客戶管理清單Repository()
		{
			var repository = new 客戶管理清單Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶管理清單Repository Get客戶管理清單Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶管理清單Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
